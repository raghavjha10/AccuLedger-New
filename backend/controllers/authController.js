...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    // Check if running on hosted platform (like Render) where SMTP ports are blocked
    if (process.env.RENDER === "true") {
      console.log(`ℹ️ Render environment detected. Bypassing SMTP and returning fallback link.`);
